...
# Using word embeddings based off of the same training data might yield better results?, but less general purpose
# than google database When user inputs new data, could also train new embeddings by appending the new data to our
# corpus
...
# Try dropping values with less than 20 words?
...
poo = conmat.plot_confusion_matrix(cm, classes=["FAKE", "REAL"])
